...
class ChapterMaster extends CI_Controller {

    public function index($cid) {
        $this->load->model( 'CMModel' );
        $results = $this->CMModel->joinedData( 'chapter_master',['course_master'=>'course_master.id = chapter_master.course_id'],'chapter_master.*,course_master.title as course_title',"chapter_master.course_id = '$cid'");
        $this->load->view( 'common/header.php' );

        $this->load->view( 'chapter/list', ['result'=>$results,'cid'=>$cid] );
